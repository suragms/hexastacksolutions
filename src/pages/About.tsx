...
const proofPoints = [
    'We built a POS system for a UAE restaurant group in 6 weeks.',
...
export default function About() {
    return (
        <Layout>
            <SEO
                title="Founded in Thrissur, Kerala - HexaStack Solutions"
                description="HexaStack Solutions is a founder-led software company in Thrissur, Kerala building websites, POS systems, billing tools, and custom software."
            ...
            <section className="border-b border-[var(--border)] bg-[radial-gradient(circle_at_top_left,rgba(37,99,235,0.12),transparent_32%),linear-gradient(180deg,rgba(255,255,255,0.98),rgba(255,255,255,0.94))] py-14 md:py-18">
                <div className="mx-auto max-w-6xl px-4 sm:px-6">
                    ...
                    <h1 className="mt-6 max-w-4xl text-4xl font-bold tracking-tight text-[var(--foreground)] sm:text-5xl md:text-[3.35rem] md:leading-[1.05]">
                        Founded in Thrissur, Kerala - HexaStack Solutions
                    </h1>
                    <p className="mt-5 max-w-3xl text-base leading-8 text-[var(--muted-foreground)] sm:text-lg">
                        We started in 2024 to build websites, POS systems, billing tools, and custom software for businesses that need clear work and fast replies.
                    </p>
                    <div className="mt-6">
                        ...
                        {founders.map((founder) => (
                            <GlassCard key={founder.name} className="p-6 sm:p-8">
                                <div className="flex items-start gap-5">
                                    <div className="relative h-20 w-20 shrink-0 overflow-hidden rounded-full border border-[var(--border)] bg-[var(--secondary)] shadow-sm">
                                        <img
                                            src={founder.image}
