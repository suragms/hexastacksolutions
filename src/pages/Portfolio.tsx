...
const portfolioItems = [
  ...
  {
    category: 'SaaS · AI',
    techLabel: 'SaaS · GPT-4o Vision',
    name: 'NutriScan AI',
    outcome: 'Idea to live SaaS product serving paying users.',
    problem: 'Founder needed an end-to-end build: architecture, UI, infra, and AI integration.',
    techStack: ['React', 'Node.js', 'OpenAI', 'Vercel'],
    to: '/work',
    featured: false,
  },
];
