        ...
        try {
            const response = await fetch(`${API_URL}/api/contact`.replace(/([^:])\/\/+/, '$1/'), {
                ...
                body: JSON.stringify({
                    ...
                    requirement: `New enquiry for ${formData.service}. Please reply on WhatsApp.`,
                }),
            });
                ...
                <div className="mx-auto grid max-w-6xl gap-8 px-4 sm:px-6 lg:grid-cols-[0.38fr_0.62fr] lg:items-start">
                    <div className="space-y-6">
                        ...
                        <div className="space-y-3">
                            ...
                            <MapEmbed title="HexaStack Solutions office in Thrissur, Kerala" height={260} className="mt-4" />
                        </div>
                    </div>
