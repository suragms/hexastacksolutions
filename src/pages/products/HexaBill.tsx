        ...
        '@graph': [
            {
                ...
                offers: {
                    ...
                    description: 'Pricing quoted after a short discovery call.',
                },
            },
    ...
    return (
        <Layout>
            ...
            <div className="max-w-5xl mx-auto px-4 sm:px-6">
                ...
                <section className="py-12 border-t border-[var(--border)]">
                    <h2 className="text-2xl font-bold mb-4">Rollout</h2>
                    <p className="text-[var(--muted-foreground)] max-w-2xl">
                        We scope HexaBill to your outlets, VAT or GST profile, branches, and reporting needs—then agree a fixed plan before build. Gulf and UAE setups follow the same discovery flow; message us on WhatsApp for a quote or book a demo.
                    </p>
                    <p className="mt-4 text-sm text-[var(--muted-foreground)] max-w-2xl">
                        Looking for ballpark ranges? See the{' '}
                        <Link to="/pricing" className="font-semibold text-[var(--primary)] underline-offset-2 hover:underline">
                            pricing page
                        </Link>
                        —final numbers always follow your scope.
                    </p>
                </section>
