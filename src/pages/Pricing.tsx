                ...
                <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                        <div className="p-6 rounded-2xl border border-[var(--border)] bg-[var(--card)] hover:border-[var(--primary)] transition-colors">
                            ...
                            <Link to="/contact" className="block w-full py-2.5 text-center rounded-full bg-[var(--primary)] text-[var(--primary-foreground)] font-semibold text-sm hover:opacity-90 transition-colors">Get a Quote</Link>
                        </div>
                        <div className="p-6 rounded-2xl border border-[var(--border)] bg-[var(--card)] hover:border-[var(--primary)] transition-colors">
                            ...
                            <Link to="/contact" className="block w-full py-2.5 text-center rounded-full border border-[var(--border)] text-[var(--foreground)] font-medium text-sm hover:bg-[var(--muted)] transition-colors">Get a Quote</Link>
                        </div>
                        <div className="p-6 rounded-2xl border border-[var(--border)] bg-[var(--card)] hover:border-[var(--primary)] transition-colors">
