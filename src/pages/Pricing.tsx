    ...
    return (
        <Layout>
            <SEO
                ...
                keywords="website development cost Kerala, software pricing Thrissur, POS system cost India, how much website Kerala 2026, restaurant POS Kerala, VAT billing software UAE, custom software SMB Thrissur"
                canonical="/pricing"
                schema={faqSchema}
            />
            <div className="bg-[var(--background)] text-[var(--foreground)] font-sans antialiased min-h-screen">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
                    <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4 text-[var(--foreground)]">
                        Software Development Pricing in Kerala — HexaStack Solutions
                    </h1>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
                        ...
                        <div className="p-6 rounded-2xl border border-[var(--border)] bg-[var(--card)] hover:border-[var(--primary)] transition-colors">
                            ...
                            <ul className="space-y-2 text-sm text-[var(--muted-foreground)] mb-6">
                                ...
                                <li>Like our other product builds, HexaBill</li>
                            </ul>
